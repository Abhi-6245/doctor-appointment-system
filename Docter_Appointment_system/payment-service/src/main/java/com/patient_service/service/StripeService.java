    ...
    public StripeResponse checkoutProducts(ProductRequest productRequest) {
        ...
        SessionCreateParams params =
                SessionCreateParams.builder()
                        ...
                        .setSuccessUrl("http://localhost:8083/product/v1/success?session_id={CHECKOUT_SESSION_ID}")
                        .setCancelUrl("http://localhost:8083/product/v1/cancel")
                        .putMetadata("bookingId", String.valueOf(productRequest.getBookingId()))
